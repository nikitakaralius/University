...
internal class Program
{
    ...
    //
    // Основная логика сосредоточена в Domain проекте. Все остальное - детали реализации:
    // консольный ввод/вывод, покраска сообщений, обработка граничных ситуаций и т.д.
